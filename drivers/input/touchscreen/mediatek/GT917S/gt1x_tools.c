 ...
 * BATCH "tools" (2026-08-22): THE NOTES ARE AT THE END OF THE FILE, not here.
 * The factory printks pin twenty-five __LINE__ values (87, 90, 97, 100,
 * 141, 185, 190, 191, 199, 222, 225, 247, 261, 270, 306, 311, 315, 327,
 * 365, 371, 379, 390, 391, 402, 414): a line added here shifts them.
 */
...
/* None of the three below is a symbol in the factory map. */
			      ...
			      size_t count, loff_t *ppos)
{
	...
	if (cmd_head.wr % 2) {
		...
		/* The factory does NOT truncate cmd_head.data_len to DATA_LENGTH here. */
		if (cmd_head.flag == 1) {
			if (comfirm()) {
 ...
 * docs/bringup/verbali-driver/drivers_input_touchscreen_mediatek_GT917S_gt1x_tools.md
