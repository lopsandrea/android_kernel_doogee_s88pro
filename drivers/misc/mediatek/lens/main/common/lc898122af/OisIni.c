...
void IniGyr(void)
{
 ...
 /* CmShtOpe[1:0] 00: �V?�b�^�[OFF, 01: �V?�b�^�[ON, 1x:�O?���� */
	...
	RamWrite32A_LC898122AF(
		gylmt4HS0,
		UlGyrLmt4); /* 0x112B        Y��Limiter4 High?�l0 */
	RamWrite32A_LC898122AF(
		gxlmt4HS0,
		UlGyrLmt4); /* 0x102B        X��Limiter4 High?�l0 */

	RamWrite32A_LC898122AF(
		gxlmt4HS1,
		UlGyrLmt4); /* 0x102C        X��Limiter4 High?�l1 */
	RamWrite32A_LC898122AF(
		gylmt4HS1,
		UlGyrLmt4); /* 0x112C        Y��Limiter4 High?�l1 */
