...
/*
 * THE INDEX OF THE SENSOR BEING POWERED UP, left here by
 * imgsensor_hw_power. The factory YUV drivers read it to know whether the
 * phone is powering THEM up. The name is the address: stock.map does not name
 * the data.
 */
