...
#include "imx230_xinfengda_mipi_Sensor.h"
...
kal_uint16 IMX230XINFENGDAMIPI_sensorGainMapping[IMX230MIPI_MaxGainIndex][2] = {
	{64, 0},
	{65, 8},
	{66, 16},
	{67, 25},
...
{
	kal_uint16 get_byte = 0;
	char pu_send_cmd[2] = { 0x00, 0x03 };
	int ret;

	ret = iReadRegI2C(pu_send_cmd, 2, (u8 *) &get_byte, 1, 0x18);
	pr_debug("---test----imx230xinfengda---get_byte===%d--ret==%d\n",
		 get_byte, ret);
	if (ret < 0)
		return 0;
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	for (iI = 0; iI < IMX230MIPI_MaxGainIndex; iI++) {
		if (gain < IMX230XINFENGDAMIPI_sensorGainMapping[iI][0])
			return IMX230XINFENGDAMIPI_sensorGainMapping[iI][1];

	}
	if (iI != IMX230MIPI_MaxGainIndex) {
		if (gain != IMX230XINFENGDAMIPI_sensorGainMapping[iI][0]) {
			pr_info("Gain mapping don't correctly:%d %d\n", gain,
				IMX230XINFENGDAMIPI_sensorGainMapping[iI][0]);
		}
	}
	pr_info("exit IMX230MIPIGain2Reg function\n");
	return IMX230XINFENGDAMIPI_sensorGainMapping[iI - 1][1];
}
...
kal_uint16 addr_data_pair_init_imx230_xinfengda[] = {
...
static void sensor_init(void)
{
	...
	imx230_table_write_cmos_sensor(addr_data_pair_init_imx230_xinfengda,
		sizeof(addr_data_pair_init_imx230_xinfengda)/sizeof(kal_uint16));
} /*    sensor_init  */

kal_uint16 addr_data_pair_preview_imx230_xinfengda[] = {
	0x0114, 0x03,
	0x0220, 0x00,
	0x0221, 0x11,
	0x0222, 0x01,
...
{
	imx230_table_write_cmos_sensor(addr_data_pair_preview_imx230_xinfengda,
		sizeof(addr_data_pair_preview_imx230_xinfengda)/sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_preview_hdr_es2_imx230_xinfengda[] = {
	0x0114, 0x03,
	0x0220, 0x03,
	0x0221, 0x22,
...
static void preview_setting_HDR_ES2(void)
{
	...
	imx230_table_write_cmos_sensor(addr_data_pair_preview_hdr_es2_imx230_xinfengda,
	   sizeof(addr_data_pair_preview_hdr_es2_imx230_xinfengda)/sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_cap_15fps_imx230_xinfengda[] = {
	0x0114, 0x03,
	0x0220, 0x00,
	0x0221, 0x11,
	0x0222, 0x01,
...
kal_uint16 addr_data_pair_cap_24fps_imx230_xinfengda[] = {
	0x0114, 0x03,
	0x0220, 0x00,
	0x0221, 0x11,
	0x0222, 0x01,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) {	/* 15fps for PIP */
		...
		imx230_table_write_cmos_sensor(addr_data_pair_cap_15fps_imx230_xinfengda,
		   sizeof(addr_data_pair_cap_15fps_imx230_xinfengda)/sizeof(kal_uint16));

	} else { /* 24fps            //2fps for Normal capture & ZSD */
		imx230_table_write_cmos_sensor(addr_data_pair_cap_24fps_imx230_xinfengda,
		   sizeof(addr_data_pair_cap_24fps_imx230_xinfengda)/sizeof(kal_uint16));
	}
}

kal_uint16 addr_data_pair_cap_es2_imx230_xinfengda[] = {
	0x0114, 0x03,
	0x0220, 0x03,
	0x0221, 0x11,
	0x0222, 0x02,	/* 0x10,modify to 2x ratio */
...
{
	imx230_table_write_cmos_sensor(addr_data_pair_cap_es2_imx230_xinfengda,
		sizeof(addr_data_pair_cap_es2_imx230_xinfengda)/sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_cap_pdaf_15fps_imx230_xinfengda[] = {
	0x0114, 0x03,
	0x0220, 0x00,
	0x0221, 0x11,
	0x0222, 0x01,
...
kal_uint16 addr_data_pair_cap_pdaf_24fps_imx230_xinfengda[] = {
	0x0114, 0x03,
	0x0220, 0x00,
	0x0221, 0x11,
	0x0222, 0x01,
...
static void capture_setting_pdaf(kal_uint16 currefps)
{
	...
	if (currefps == 150) {	/* 15fps for PIP */
		...
		imx230_table_write_cmos_sensor(
			addr_data_pair_cap_pdaf_15fps_imx230_xinfengda,
	   sizeof(addr_data_pair_cap_pdaf_15fps_imx230_xinfengda)/sizeof(kal_uint16));


	} else { /* 24fps            //24fps for Normal capture & ZSD */
		imx230_table_write_cmos_sensor(
			addr_data_pair_cap_pdaf_24fps_imx230_xinfengda,
	   sizeof(addr_data_pair_cap_pdaf_24fps_imx230_xinfengda)/sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_video_imx230_xinfengda[] = {
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	pr_info("E! currefps:%d\n", currefps);
	imx230_table_write_cmos_sensor(addr_data_pair_video_imx230_xinfengda,
		sizeof(addr_data_pair_video_imx230_xinfengda)/sizeof(kal_uint16));

}
kal_uint16 addr_data_pair_video_hdr_imx230_xinfengda[] = {
	0x0114, 0x03,
	0x0220, 0x03,
	0x0221, 0x11,
	0x0222, 0x02,	/* 0x10,modify to 2x ratio */
...
{
	pr_info("E\n");
	imx230_table_write_cmos_sensor(addr_data_pair_video_hdr_imx230_xinfengda,
		sizeof(addr_data_pair_video_hdr_imx230_xinfengda)/sizeof(kal_uint16));
}
kal_uint16 addr_data_pair_hs_video_imx230_xinfengda[] = {
	0x0114, 0x03,
	0x0220, 0x00,
	0x0221, 0x11,
	0x0222, 0x01,
...
{
	pr_info("E\n");
	imx230_table_write_cmos_sensor(addr_data_pair_hs_video_imx230_xinfengda,
		sizeof(addr_data_pair_hs_video_imx230_xinfengda)/sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_slim_video_imx230_xinfengda[] = {
	0x0114, 0x03,
	0x0220, 0x00,
	0x0221, 0x11,
	0x0222, 0x01,
...
static void slim_video_setting(void)
{
	...
	imx230_table_write_cmos_sensor(addr_data_pair_slim_video_imx230_xinfengda,
		sizeof(addr_data_pair_slim_video_imx230_xinfengda)/sizeof(kal_uint16));
}
...
static kal_uint32 open(void)
{
	...
	read_imx230_xinfengda_SPC(imx230_SPC_data);
	sensor_init();
...
static kal_uint32 imx230_awb_gain(struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
	...
	pr_info("[%s] ABS_GAIN_GR:%d, grgain_32:%d\n",
		__func__,
		pSetSensorAWB->ABS_GAIN_GR,
		grgain_32);
	pr_info("[%s] ABS_GAIN_R:%d, rgain_32:%d\n",
		__func__,
		pSetSensorAWB->ABS_GAIN_R,
		rgain_32);
	pr_info("[%s] ABS_GAIN_B:%d, bgain_32:%d\n",
		__func__,
		pSetSensorAWB->ABS_GAIN_B,
		bgain_32);
	pr_info("[%s] ABS_GAIN_GB:%d, gbgain_32:%d\n",
		__func__,
 ...
 */
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		...
		read_imx230_xinfengda_DCC((kal_uint16) (*feature_data),
...
UINT32 IMX230XINFENGDA_MIPI_RAW_SensorInit(
